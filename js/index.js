...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const yearTypeValueBetweenMin = document.querySelector("#yearTypeValueBetweenMin");
    const yearTypeValueBetweenMax = document.querySelector("#yearTypeValueBetweenMax");
    ...
    const ratingTypeRadioBetween = document.querySelector("#ratingTypeRadioBetween");
    const ratingTypeValueBetweenMin = document.querySelector("#ratingTypeValueBetweenMin");
    const ratingTypeValueBetweenMax = document.querySelector("#ratingTypeValueBetweenMax");
    ...
    function filterMovies(sortedMovies) {
        for (let i = 0; i < sortedMovies.length; i++) {
            ...
            if (titleFilterInput.value) {
                if (!sortedMovies[i].title.toLowerCase().includes(titleFilterInput.value.toLowerCase())) {
            ...
            if (yearTypeRadioBefore.checked) {
                if (sortedMovies[i] && sortedMovies[i].release_date > yearTypeValueBefore.value) {
                    delete sortedMovies[i];
                }
            }
            ...
            if (yearTypeRadioAfter.checked) {
                if (sortedMovies[i] && sortedMovies[i].release_date < yearTypeValueAfter.value) {
                    delete sortedMovies[i];
                }
            }
            ...
            if (yearTypeRadioBetween.checked) {
                if (sortedMovies[i]) {
                    if (!(sortedMovies[i].release_date < yearTypeValueBetweenMax.value && sortedMovies[i].release_date > yearTypeValueBetweenMin.value)) {
                        delete sortedMovies[i];
                    }
                }
            }
            ...
            if (ratingTypeRadioBelow.checked) {
                if (sortedMovies[i] && sortedMovies[i].ratings.average > ratingTypeValueBelow.value) {
                    delete sortedMovies[i];
                }
            }
            ...
            if (ratingTypeRadioAbove.checked) {
                if (sortedMovies[i] && sortedMovies[i].ratings.average < ratingTypeValueAbove.value) {
                    delete sortedMovies[i];
                }
            }
            ...
            if (ratingTypeRadioBetween.checked) {
                console.log("ratingTypeValueBetweenMax:" + ratingTypeValueBetweenMax.value + " ratingTypeValueBetweenMin: " + ratingTypeValueBetweenMin.value);
                if (sortedMovies[i]) {
                    if (!(sortedMovies[i].ratings.average <= ratingTypeValueBetweenMax.value && sortedMovies[i].ratings.average >= ratingTypeValueBetweenMin.value)) {
                        delete sortedMovies[i];
                    }
                }
            }
    ...
    const ratingBetweenMinValue = document.querySelector("#ratingBetweenMinValue");
    const ratingBetweenMaxValue = document.querySelector("#ratingBetweenMaxValue");
    ...
    const largerPosterElement = document.querySelector("#largerMovieDetailPoster");
